...
console.log('');
console.log('  3. Bake a worker AMI (recommended default — workers boot ready, no S3 download):');
console.log('       npx burstgrid bake-ami --source-ami <stock-ubuntu-ami>');
console.log('       # writes the baked AMI ID into worker_ami below automatically.');
console.log('       # Skip this step to fall back to downloading rootfs/vmlinux from S3 at boot (slower, still supported).');
console.log('');
console.log('  4. Set GitHub credentials (choose one):');
...
console.log('');
console.log('  5. Deploy infrastructure:');
console.log('       npx burstgrid deploy');
console.log('');
console.log('  6. Populate burstgrid.config.yaml with the new launch template IDs:');
console.log('       npx burstgrid init');
console.log('');
console.log('  7. Register GitHub webhook:');
