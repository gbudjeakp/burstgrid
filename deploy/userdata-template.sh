...
/usr/local/bin/aws s3 cp "s3://burstgrid-artifacts-YOUR_ACCOUNT_ID/worker-agent.mjs" \
...
Environment=BURSTGRID_SPOT_QUEUE_URL=https://sqs.us-east-1.amazonaws.com/YOUR_ACCOUNT_ID/burstgrid-spot-interruptions
